...
class ViewDeposit extends StatefulWidget {
  const ViewDeposit({Key? key}) : super(key: key);

  @override
  State<ViewDeposit> createState() => _ViewDepositState();
}

class _ViewDepositState extends State<ViewDeposit> {
  List pages = [
    AccountDetails(),
    Transfer(),
    Deposit(),
